(() => {
  ...
  var loadFont = (fontName, fontStyle, fontWeight) => {
  ...
  var fontsLoader = (fonts, callback) => __async(void 0, null, function* () {
    if (!fonts.length) {
  ...
  var styleSheetsLoader = (styleSheets, callback) => __async(void 0, null, function* () {
    ...
    load() {
      ...
      const fontLoad = new Promise((resolve) => {
        fontsLoader(this.options.fonts, () => {
          html.classList.add(config_default.CSS_CLASS.FONTS_LOADED);
          resolve();
        });
      });
      const imagePreload = new Promise((resolve) => {
        preloadImages(this.options.preloadImage, () => {
          html.classList.add(config_default.CSS_CLASS.IMAGES_PRELOADED);
          resolve();
        });
      });
